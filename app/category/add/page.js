...
const page = () => {
  ...
  return (
    <div className="flex flex-col py-10 px-14 gap-10 bg-formBG rounded-md">
      <h1 className="py-4 px-6 text-xl w-full border-none bg-inputBG shadow-sm text-textBlack">
        Add Category
      </h1>
      ...
      >
        <div className="flex flex-col h-fit w-full gap-2">
          <h4 className="ml-3 text-lg text-textBlack">Category Name</h4>
          <input
            name="category"
            value={category}
        ...
        <div className="flex flex-col h-fit w-full gap-2">
          <h4 className="ml-3 text-lg text-textBlack">Subtitle</h4>
          <input
            name="subtitle"
            value={subtitle}
